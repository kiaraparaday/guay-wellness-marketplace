...
import { ArrowLeft, Calendar, Clock, Users, Download, Globe, Tag } from "lucide-react";
...
const solutionTypes = {
  ...
  programa: { label: "Programa", color: "bg-purple-100 text-purple-800" },
...
const Solution = () => {
  ...
  const handleDownloadPDF = () => {
    alert("La información ha sido descargada en formato PDF");
  };
            ...
            <div className="lg:col-span-2">
              <div className="mb-8">
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  <span className={`px-2.5 py-1 rounded-md text-sm font-medium ${solutionTypes[solution.type]?.color || "bg-gray-100 text-gray-800"}`}>
                ...
                {solution.categories && solution.categories.length > 0 && (
                  <div className="flex flex-wrap gap-2 mb-6">
                    ...
                    {solution.categories.map((category, index) => (
                      <span 
                        key={index}
                        className="text-sm bg-blue-50 hover:bg-blue-100 text-blue-700 border border-blue-200 px-2 py-1 rounded"
                      >
                        {category}
                      </span>
                    ))}
